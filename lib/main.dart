...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void loadSetting() async {
    ...
    g_ua =
        "${packageInfo.packageName}/${packageInfo.version}.${packageInfo.buildNumber} (${Platform.operatingSystem}/${Platform.operatingSystemVersion})";
    if (kDebugMode) {
      print("[UA] g_ua");
    }
  }
